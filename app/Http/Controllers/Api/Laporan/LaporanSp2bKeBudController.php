...
class LaporanSp2bKeBudController extends Controller
{
    ...
    private function getDashboardSpbPivot(
        ...
        $rows = DB::select("
            ...
            JOIN REF_OPD
                ON AKSES_SP2B_KE_BUD.KD_OPD1 = REF_OPD.KD_OPD1
               AND AKSES_SP2B_KE_BUD.KD_OPD2 = REF_OPD.KD_OPD2
               AND AKSES_SP2B_KE_BUD.KD_OPD3 = REF_OPD.KD_OPD3
               AND AKSES_SP2B_KE_BUD.KD_OPD4 = REF_OPD.KD_OPD4
               AND AKSES_SP2B_KE_BUD.KD_OPD5 = REF_OPD.KD_OPD5
    ...
    public function getDashboardSpb(Request $request)
    {
