...
class LaporanPajakBendaharaResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            // ======================
            'tahun'           => $this->tahun,
            'ref_pajak_id'    => $this->ref_pajak_id,
            'nama_pajak'      => $this->refPajakBendahara?->nm_pajak_bendahara,
            ...
            // RELASI
            // ======================
            'refPajakBendahara' => new RefPajakBendaharaResource(
                $this->whenLoaded('refPajakBendahara')
            ),
