...
class AksesOperatorModel extends Model
{
    use SoftDeletes;

    protected $connection = 'oracle';
    protected $table = 'akses_operator';
    protected $primaryKey = 'id';
    public $incrementing = false; // karena ID diisi oleh trigger NO_OPERATOR
    ...
    // Mapping timestamp untuk Oracle
